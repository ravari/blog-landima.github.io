...
(function($, window) {
    ...
    $(window).bind('validatorsLoaded', function() {
      ...
      $.formUtils.LANG = {
          ...
          requiredField: 'شما این فیلد ضروری را تکمیل نکرده اید',
          requiredFields: 'شما همه فیلدهای ضروری را تکمیل نکرده اید',
          ...
          lengthTooLongStart: 'مقدار ورودی نباید بیشتر از ',
          lengthTooShortStart: 'مقدار ورودی نباید کمتر از ',
          ...
          badreCaptcha: 'ثابت کنید شما ربات نیستید',
          min : 'حداقل',
          max : 'حداکثر',
